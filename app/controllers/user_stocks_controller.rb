class UserStocksController < ApplicationController
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, 
          notice: "#{@user_stock.stock.ticker} stock was added to your portfolio."}
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: "#{@user_stock.stock.name} stock was removed from your portfolio." }
